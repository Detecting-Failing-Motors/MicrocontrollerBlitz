...
def do_measurement():
    ...
    for data_row in itertools.cycle(filter_buffer):
            ...
            ch_buffer = ads2.read_sequence(CH_SEQUENCE, data_row)
...
#                 nice_output(elapsed, ch_buffer)
                CSVout(elapsed, ch_buffer)
...
try:
    ...
    np.savetxt("AccelerometerNewRun2.csv", emptyarray, fmt='%s', delimiter=",")
